    ...
    return (
        <div className="min-h-screen bg-[#fafcff] flex flex-col relative">
            ...
            <main className="flex-1 pt-32 px-6 max-w-[1000px] mx-auto w-full pb-20">
                ...
                {/* Profile Header */}
                <div className="bg-white rounded-[32px] p-8 md:p-10 border border-gray-100 shadow-xl shadow-blue-900/5 mb-8 flex flex-col md:flex-row items-center md:items-start gap-8 relative overflow-hidden">
