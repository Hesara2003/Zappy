...
const CASE_STUDIES = [
    {
        ...
        title: 'Major League Baseball™ and Zappy expand the employee-fan experience',
        quote: '"Zappy has allowed us to continue a tradition of really being a technology-focused company and making sure that we\'re using cutting-edge technology..."',
        author: 'Noah Garden',
    ...
    },
    {
        id: 'cricut',
        company: 'Cricut',
        title: 'Empowering creativity and connection with Zappy',
        quote: '"Zappy helps us bring our community together, enabling creators to share their passion and learn from one another."',
        author: 'Robert Smith',
    ...
    },
    {
        ...
        quote: '"We are using Zappy to transform how we work, ensuring our teams can innovate faster and serve customers better."',
            ...
            <div className="max-w-[1400px] mx-auto px-6">
                ...
                <div className="max-w-5xl mx-auto text-center mb-36">
                    <h3 className="text-2xl md:text-[40px] leading-[1.3] font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#00053d] to-[#0b5cff] mb-10 tracking-tight">
                        "Zappy Workplace turns my brainwaves into polished gems. From meetings, I can create Clips, Notes, Docs, or even whiteboards faster than you can say, 'transcript.'"
                    </h3>
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl md:text-[64px] font-bold leading-[1.05] tracking-tight text-[#00053d]">
                        Companies are achieving more<br />with Zappy
                    </h2>
                </div>
