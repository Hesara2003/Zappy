...
export const FeaturedPlacesSection: React.FC = () => {
  return (
    <section className="py-24 px-6 bg-black relative overflow-hidden">
       {/* Ambient Background */}
      <div className="absolute right-0 top-0 w-[800px] h-[800px] bg-indigo-900/20 rounded-full blur-[120px] pointer-events-none translate-x-1/3 -translate-y-1/4"></div>
      <div className="absolute left-0 bottom-0 w-[600px] h-[600px] bg-blue-900/10 rounded-full blur-[100px] pointer-events-none -translate-x-1/4 translate-y-1/4"></div>
