          ...
          <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-8 lg:pl-12">
            <div>
              ...
              <ul className="space-y-4">
                {['Zappy Blog', 'Customers', 'Our Team', 'Careers', 'Integrations', 'Partners', 'Investors', 'Press'].map(item => (
            ...
            <div>
              ...
              <ul className="space-y-4">
                {['Zappy Client', 'Zappy Rooms', 'Browser Extension', 'Outlook Plug-in', 'iPhone/iPad App', 'Android App'].map(item => (
                  <li key={item}><a href="#" className="hover:text-[#0b5cff] transition-colors">{item}</a></li>
                ))}
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                {['Test Zappy', 'Account', 'Support Center', 'Live Training', 'Feedback', 'Contact Us', 'Accessibility', 'Privacy, Security, Legal'].map(item => (
                  <li key={item}><a href="#" className="hover:text-[#0b5cff] transition-colors">{item}</a></li>
                ))}
              </ul>
            </div>
